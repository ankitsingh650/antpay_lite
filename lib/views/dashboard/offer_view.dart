...
import '../../model/homebanner/offer_details_by_category_model.dart' as categoryOffer;
...
class _OfferViewState extends State<OfferView> {
  ...
  // Your widget tree that includes OfferView
    ...
    final categoryOffer.OfferDetails? offerDetails;
    if(ModalRoute.of(context)?.settings.arguments is Offer){
      ...
      offerData=null;
      offerDetails= ModalRoute.of(context)?.settings.arguments as categoryOffer.OfferDetails;
